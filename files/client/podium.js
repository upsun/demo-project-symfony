let localEndpoint = "http://localhost:8002/";
let backendUrl = '';
    ...
    return (
        <div className="row">
            <div className="col-12">
                <div className="divTable table table-striped table-borderless table-hover">
                    <div className="divTableHeading">
                        <div className="divTableRow bg-info">
                            ...
                            <div className="divTableHead">Distance from conference</div>
                        </div>
                    </div>
                ...
                <div id="root">
                    <div className="podium-container">
                        <div className={'podium-title'}>
                            <h1>Who traveled the furthest?</h1>
                        </div>
                        <div className={'podium'}>
                            <div className={'item-block-second'}>
                                <div className={'image-container'}><img src={podium[1].picture} alt=""/></div>
                                <div>{podium[1].username}</div>
                                <div>({podium[1].city}; {podium[1].distance / 1000} km)</div>
                            ...
                            <div className={'item-block-first'}>
                                ...
                                <div>{podium[0].username}</div>
                                <div>({podium[0].city}; {podium[0].distance / 1000} km)</div>
                            ...
                            <div className={'item-block-third'}>
                                ...
                                <div>{podium[2].username}</div>
                                <div>({podium[2].city}; {podium[2].distance / 1000} km)</div>
